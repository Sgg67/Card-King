...
### Scan card
This allows users to scan the front and back of their cards and receive the average value of the card
and other key info about the card.
